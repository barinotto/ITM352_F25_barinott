...
def clean_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Trim whitespace from object/string columns and normalize missing markers
    ...
    # Try to coerce borough to Int64 if it's numeric
...
def main():
    ...
    # Read everything as strings, then clean/coerce
    ...
    # Print the cleaned dtypes for the subset, then the rows (no other text)
